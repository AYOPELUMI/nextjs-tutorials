	...
	return (
		<>
			<label className={Props.labelClass}>
				...
				<input type={Props.type} name="" id="" placeholder={Props.placeHolder} className=" rounded-md border focus:border-tahiti hover: border-tahiti invalid:border-pink-500 invalid:text-pink-600
